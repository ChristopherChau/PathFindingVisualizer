...
const Legend = () => {
    const legendItems = [
      { label: "Start Node", image: "https://static.vecteezy.com/system/resources/previews/034/371/682/non_2x/simple-map-pin-icon-location-information-and-the-current-location-icon-vector.jpg" },
      { label: "End Node", image: "https://static.vecteezy.com/system/resources/thumbnails/023/257/613/small/flag-icon-isolated-illustration-vector.jpg" },
